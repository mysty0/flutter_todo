...
abstract class $AuthStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool biometricsAvailable, bool enabled});
}
...
class _$_AuthState with DiagnosticableTreeMixin implements _AuthState {
  const _$_AuthState(
      {required this.biometricsAvailable, required this.enabled});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'AuthState(biometricsAvailable: $biometricsAvailable, enabled: $enabled)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('biometricsAvailable', biometricsAvailable))
  ...
  @override
  int get hashCode => Object.hash(runtimeType, biometricsAvailable, enabled);
...
abstract class _AuthState implements AuthState {
  const factory _AuthState(
      ...
      required final bool enabled}) = _$_AuthState;
